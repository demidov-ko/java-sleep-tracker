...
import ru.yandex.practicum.sleeptracker.function.MaxSessionDurationFunction;
...
class MaxSessionDurationFunctionTest {
    private MaxSessionDurationFunction function;

    @BeforeEach
    void setUp() {
        function = new MaxSessionDurationFunction();
    }
    ...
    @Test
    void testApplySessionsReturnsMaxDuration() {
