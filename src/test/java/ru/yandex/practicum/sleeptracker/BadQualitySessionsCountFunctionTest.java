...
import ru.yandex.practicum.sleeptracker.function.BadQualitySessionsCountFunction;
...
class BadQualitySessionsCountFunctionTest {
    private BadQualitySessionsCountFunction function;

    @BeforeEach
    void setUp() {
        function = new BadQualitySessionsCountFunction();
    }
    ...
    @Test
    void testApplyNoBadQualitySessionsReturnsZero() {
    ...
    @Test
    void testApplyBadQualitySessionsReturnsCorrectCount() {
        List<SleepingSession> sessions = List.of(
                new SleepingSession(
                        LocalDateTime.of(2026, 1, 25, 23, 0),
                        LocalDateTime.of(2026, 1, 26, 8, 30),
