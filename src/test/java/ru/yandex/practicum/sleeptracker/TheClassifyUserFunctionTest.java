...
class TheClassifyUserFunctionTest {
    ...
    @Test
    void testEqualAllChronotypesReturnsGolub() {
        List<SleepingSession> sessions = List.of(
                new SleepingSession(
                        LocalDateTime.of(2026, 1, 10, 21, 0),
                        LocalDateTime.of(2026, 1, 11, 6, 0),
                        Quality.GOOD),
                new SleepingSession(
                        LocalDateTime.of(2026, 1, 11, 23, 30),
                        LocalDateTime.of(2026, 1, 12, 10, 0),
                        Quality.GOOD),
                new SleepingSession(
                        LocalDateTime.of(2026, 1, 12, 22, 30),
    ...
    @Test
    void testDaytimeSessionsAreIgnored() {
        List<SleepingSession> sessions = List.of(
                new SleepingSession(
